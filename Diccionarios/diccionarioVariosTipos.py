...
"""
cargar un codigo de producto como diccionario. Guardar para dicha clave
el nombre del producto, su precio y cantidad en stock
1. carga de datos en el diccionario
2. listado completo de productos 
3. consulta de un producto clave, mostrar el nombre, precio y stock. 
