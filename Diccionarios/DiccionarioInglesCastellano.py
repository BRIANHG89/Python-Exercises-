...
"""
crear un diccionario ingles/castellano.
La clave es la palabra en ingles
y el valor es la palabra en castellano.
...
def consulta_palabra(diccionario):
     pal=input("Ingrese la palabra en ingles a consulta:")
